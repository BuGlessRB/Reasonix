...
export const EN: Record<string, string> = {
  ...
  "改动了但没有任何验证": "changed, with nothing verifying it",
  ...
  "移动…": "Move…",
  "开始搬迁": "Start the move",
  "目标文件夹的完整路径，例如 D:/reasonix/sessions":
    "Full path to the destination folder, e.g. D:/reasonix/sessions",
  ...
  "转录、压缩归档、用量统计、回溯快照": "Transcripts, compaction archives, usage stats, rewind snapshots",
  "索引与缓存": "Indexes and caches",
  "搜索索引与派生数据，删掉会自动重建": "Search indexes and derived data; deleting them rebuilds them",
