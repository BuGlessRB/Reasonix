...
export const EN_SETTINGS: Record<string, string> = {
  ...
  "{n} 个来源": "{n} sources",
  "添加来源": "Add source",
  "先连接模型服务，再从其目录选择主模型。自定义中转站可以命名，协议与模型会在连接后自动探测。": "Connect a model service first, then choose a primary model from its catalog. Custom gateways can be named; protocol and models are detected after connection.",
  ...
  "请求与能力": "Request and capabilities",
  "思考、联网搜索与上下文续接": "Thinking, web search and context continuation",
