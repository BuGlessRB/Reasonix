...
export const ACTIONS: UIAction[] = [
  ...
  { id: "decision.typesafe-url", kind: "view", target: "none", proof: "interaction" },
  { id: "decision.typesafe-model", kind: "view", target: "none", proof: "interaction" },
  { id: "decision.typesafe-key", kind: "view", target: "none", proof: "interaction" },
  { id: "decision.laya-local", kind: "view", target: "none", proof: "interaction" },
  { id: "decision.laya-python", kind: "view", target: "none", proof: "interaction" },
  { id: "decision.laya-model", kind: "view", target: "none", proof: "interaction" },
  { id: "decision.laya-url", kind: "view", target: "none", proof: "interaction" },
  { id: "decision.laya-key", kind: "view", target: "none", proof: "interaction" },
  { id: "decision.save", kind: "kernel-mutation", target: "none", proof: "authority-effect" },
