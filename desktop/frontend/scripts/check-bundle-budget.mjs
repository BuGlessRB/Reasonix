...
// real range exists (#9703/#9711), while Sticky Context adds session-scoped
// file chips. The combined stable/test startup path measures 461.6 KiB; retain
// only the next one-decimal ceiling.
