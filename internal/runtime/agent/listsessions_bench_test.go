...
//
//	REASONIX_BENCH=1 go test ./internal/runtime/agent -run TestListSessionsScalingManual -v
...
//
//	REASONIX_BENCH=1 go test ./internal/runtime/agent -run TestColdStartProjectTreeManual -v
