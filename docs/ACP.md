...
(`completion_validation = "enforce"`, the unconfigured default), Reasonix sends a `[warning]`, returns
...
30 seconds. Set `completion_validation = "shadow"` for record-only evaluation
