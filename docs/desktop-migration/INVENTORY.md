...
| `AddMCPServer` | `(in MCPServerInput) (int, error)` | desktop/app.go:8445 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `AddSkillPath` | `(path string) error` | desktop/app.go:8094 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `AttachDropped` | `(path string) (DroppedItem, error)` | desktop/app.go:11045 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `AttachmentDataURL` | `(path string) (string, error)` | desktop/app.go:11022 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `AuthorizeAndConnectMCPServer` | `(name string) error` | desktop/app.go:7046 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `AvailableSubagentTools` | `() []ToolView` | desktop/app.go:7413 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `BackgroundRuntimes` | `() []BackgroundRuntimeView` | desktop/background_runtime.go:158 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `Balance` | `() BalanceInfo` | desktop/app.go:6247 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `BalanceForTab` | `(tabID string) BalanceInfo` | desktop/app.go:6251 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `CancelJob` | `(jobID string) (bool, error)` | desktop/app.go:6341 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `CancelJobForTab` | `(tabID string, jobID string) (bool, error)` | desktop/app.go:6347 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `CancelTask` | `(taskID string, expectedVersion uint64, reason string, idemKey string) (taskmonitor.ControlResult, error)` | desktop/app.go:11717 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `CancelTaskForTab` | `(tabID string, taskID string, expectedVersion uint64, reason string, idemKey string) (taskmonitor.ControlResult, error)` | desktop/app.go:11725 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `CancelTrySubagentProfile` | `()` | desktop/subagents_app.go:389 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `Capabilities` | `() CapabilitiesView` | desktop/app.go:6927 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `Commands` | `() []CommandInfo` | desktop/app.go:6690 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ConfirmAction` | `(req NativeConfirmRequest) (bool, error)` | desktop/app.go:11827 | migrate-host (迁移宿主实现) | `business in Go; native step through nativeHost host/*` |
...
| `ConnectKey` | `(apiKey string) (string, error)` | desktop/app.go:11894 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ContextUsageForTab` | `(tabID string) ContextInfo` | desktop/app.go:6173 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `CreatePresentedBrowserPreviewForTab` | `(tabID string, toolCallID string, path string) (string, error)` | desktop/app.go:10440 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `CreateWorkspaceBrowserPreviewForTab` | `(tabID string, rel string) (string, error)` | desktop/app.go:10424 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `CurrentTaskSessionID` | `() string` | desktop/app.go:11640 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `Effort` | `() EffortInfo` | desktop/app.go:9549 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `EffortForTab` | `(tabID string) EffortInfo` | desktop/app.go:9553 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `Forget` | `(name string) error` | desktop/app.go:11367 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ForgetForTab` | `(tabID string, name string) error` | desktop/app.go:11371 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `GetTask` | `(taskID string) (*taskmonitor.TaskSnapshot, error)` | desktop/app.go:11686 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `InstallMCPServer` | `(in MCPServerInput) (plugin.MCPInstallResult, error)` | desktop/app.go:8359 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `Jobs` | `() []JobView` | desktop/app.go:6330 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `JobsForTab` | `(tabID string) []JobView` | desktop/app.go:6334 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ListDir` | `(rel string) []DirEntry` | desktop/app.go:10033 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ListDirForTab` | `(tabID string, rel string) []DirEntry` | desktop/app.go:10038 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ListTaskEventsForTab` | `(tabID string, taskID string, afterSequence int) ([]taskmonitor.TaskEvent, error)` | desktop/app.go:11690 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ListTaskPage` | `(req TaskPageRequest) TaskPage` | desktop/task_catalog.go:137 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ListTasks` | `() ([]taskmonitor.TaskSnapshot, error)` | desktop/app.go:11633 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ListTasksForSession` | `(sessionID string) ([]taskmonitor.TaskSnapshot, error)` | desktop/app.go:11651 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ListTasksForTab` | `(tabID string) ([]taskmonitor.TaskSnapshot, error)` | desktop/app.go:11661 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `MCPMarketplace` | `(query string) (MCPMarketplaceView, error)` | desktop/app.go:6968 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `MCPMarketplaceResolve` | `(registryName string) (MCPMarketplaceEntryView, error)` | desktop/app.go:6989 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `MCPServers` | `() []ServerView` | desktop/app.go:6939 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `Memory` | `() MemoryView` | desktop/app.go:11238 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `MemoryForTab` | `(tabID string) MemoryView` | desktop/app.go:11248 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `MemoryRevisions` | `(ref string) []MemoryFact` | desktop/app.go:11448 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `MemoryRevisionsForTab` | `(tabID string, ref string) []MemoryFact` | desktop/app.go:11452 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `Meta` | `() Meta` | desktop/app.go:6412 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `MetaForTab` | `(tabID string) Meta` | desktop/app.go:6423 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `Models` | `() []ModelInfo` | desktop/app.go:9040 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `NeedsOnboarding` | `() bool` | desktop/app.go:11875 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `OpenPresentedPathForTab` | `(tabID string, toolCallID string, path string) error` | desktop/app.go:10511 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `OpenTaskSessionForTab` | `(tabID string, taskID string) (taskmonitor.ControlResult, error)` | desktop/app.go:11744 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `OpenWorkspacePathForTab` | `(tabID string, rel string) error` | desktop/app.go:10542 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `PermissionSnapshotForTab` | `(tabID string) (control.PermissionSnapshot, error)` | desktop/app.go:6579 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `PickExportFile` | `(defaultFilename string, mimeType string) (string, error)` | desktop/app.go:10745 | migrate-host (迁移宿主实现) | `business in Go; native step through nativeHost host/*` |
| `PickPluginFolder` | `() (string, error)` | desktop/app.go:8074 | migrate-host (迁移宿主实现) | `business in Go; native step through nativeHost host/*` |
...
| `PickSkillFolder` | `() (string, error)` | desktop/app.go:8056 | migrate-host (迁移宿主实现) | `business in Go; native step through nativeHost host/*` |
...
| `ReadFile` | `(rel string) FilePreview` | desktop/app.go:10165 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ReadFileForTab` | `(tabID string, rel string) FilePreview` | desktop/app.go:10170 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ReadPresentedFileForTab` | `(tabID string, toolCallID string, path string) FilePreview` | desktop/app.go:10344 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ReadPresentedFileSourceForTab` | `(tabID string, toolCallID string, path string) FilePreview` | desktop/app.go:10352 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ReadPresentedTextPageForTab` | `(tabID string, toolCallID string, path string, offset int64, expectedVersion string) (PresentedTextPage, error)` | desktop/app.go:10363 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ReconnectMCPServer` | `(name string) error` | desktop/app.go:8607 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RefreshSkills` | `() error` | desktop/app.go:8155 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `RegisterNavigationIntent` | `(token string) error` | desktop/navigation_intent.go:20 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ReloadCommands` | `() error` | desktop/app.go:8170 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `Remember` | `(scope string, note string) (string, error)` | desktop/app.go:11339 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `RememberForTab` | `(tabID string, scope string, note string) (string, error)` | desktop/app.go:11343 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RemoveMCPServer` | `(name string) error` | desktop/app.go:8545 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RemoveSkillPath` | `(path string) error` | desktop/app.go:8115 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RequeueTaskForTab` | `(tabID string, taskID string, expectedVersion uint64, idemKey string) (taskmonitor.ControlResult, error)` | desktop/app.go:11736 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ResolvePresentedPathForTab` | `(tabID string, toolCallID string, path string) (string, error)` | desktop/app.go:10521 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RestoreArchivedMemory` | `(archivePath string) (MemoryFact, error)` | desktop/app.go:11395 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `RestoreArchivedMemoryForTab` | `(tabID string, archivePath string) (MemoryFact, error)` | desktop/app.go:11399 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RestoreMemoryRevision` | `(ref string, revision int) (MemoryFact, error)` | desktop/app.go:11478 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `RestoreMemoryRevisionForTab` | `(tabID string, ref string, revision int) (MemoryFact, error)` | desktop/app.go:11482 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RevealPath` | `(path string) error` | desktop/app.go:10570 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `RevealPresentedPathForTab` | `(tabID string, toolCallID string, path string) error` | desktop/app.go:10525 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RevealWorkspacePathForTab` | `(tabID string, rel string) error` | desktop/app.go:10551 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RevokePermissionGrantForTab` | `(tabID string, scope string, target string, expectedRevision uint64) (control.PermissionSnapshot, error)` | desktop/app.go:6646 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `RevokeWorkspaceBrowserPreview` | `(rawURL string)` | desktop/app.go:10470 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `RevokeWorkspaceMediaPreview` | `(resourceURL string)` | desktop/app.go:10492 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SaveClipboardImage` | `() (string, error)` | desktop/app.go:10730 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SaveDoc` | `(path string, body string) (string, error)` | desktop/app.go:11510 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SaveDocForTab` | `(tabID string, path string, body string) (string, error)` | desktop/app.go:11514 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SaveExportFile` | `(path string, payload string, base64Encoded bool) error` | desktop/app.go:10769 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SaveExportImageFiles` | `(path string, payloads []string) error` | desktop/app.go:10794 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SavePastedFile` | `(name string, dataURL string) (string, error)` | desktop/app.go:10737 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SavePastedImage` | `(dataURL string) (string, error)` | desktop/app.go:10722 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SavePresentedPathAsForTab` | `(tabID string, toolCallID string, path string) (string, error)` | desktop/app.go:10533 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SaveWorkspacePathAsForTab` | `(tabID string, rel string) (string, error)` | desktop/app.go:10561 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SearchFileRefs` | `(query string) []DirEntry` | desktop/app.go:10090 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SearchFileRefsForTab` | `(tabID string, query string) []DirEntry` | desktop/app.go:10095 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetAgentPreset` | `(preset string) error` | desktop/app.go:9748 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetAgentPresetForTab` | `(tabID string, preset string) error` | desktop/app.go:9755 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetAutoApproveTools` | `(on bool)` | desktop/app.go:6533 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetBypass` | `(on bool)` | desktop/app.go:6539 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetEffort` | `(level string) error` | desktop/app.go:9569 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetEffortForTab` | `(tabID string, level string) error` | desktop/app.go:9573 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetMCPServerEnabled` | `(name string, enabled bool) error` | desktop/app.go:8651 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetMCPServerTier` | `(name string, tier string) error` | desktop/app.go:8755 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetModel` | `(name string) error` | desktop/app.go:9319 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetModelForTab` | `(tabID string, name string) error` | desktop/app.go:9335 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetPermissionPresetForTab` | `(tabID string, preset string, expectedRevision uint64) (control.PermissionSnapshot, error)` | desktop/app.go:6605 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetSkillEnabled` | `(name string, enabled bool) error` | desktop/app.go:8186 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetSkillImplicitInvocation` | `(enabled bool) error` | desktop/app.go:7379 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetSkillPathEnabled` | `(path string, enabled bool) error` | desktop/app.go:8137 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetTokenMode` | `(mode string) error` | desktop/app.go:9737 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetTokenModeForTab` | `(tabID string, mode string) error` | desktop/app.go:9742 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetToolApprovalMode` | `(mode string)` | desktop/app.go:6543 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetToolApprovalModeForTab` | `(tabID string, mode string) []string` | desktop/app.go:6549 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SkillsSettings` | `() SkillsSettingsView` | desktop/app.go:7316 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `StopTask` | `(taskID string, expectedVersion uint64, reason string, idemKey string) (taskmonitor.ControlResult, error)` | desktop/app.go:11698 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `StopTaskForTab` | `(tabID string, taskID string, expectedVersion uint64, reason string, idemKey string) (taskmonitor.ControlResult, error)` | desktop/app.go:11706 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `UpdateMCPServer` | `(name string, in MCPServerInput) error` | desktop/app.go:8458 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `mcp-registry-v0.1.json` |  | desktop/app.go:7004 | keep-business (保留业务实现) | format unchanged; read by both shells |
